...
| bspwm/sxhkd | bspwm/sxhkd identity or `SXHKD_CONFIG` | literal sxhkd key/command pairs | no version claim | literal chords and commands | process activation, reload, shell expansion, and ordering |
